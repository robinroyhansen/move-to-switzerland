    ...
    <>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl text-navy font-semibold mb-8">
            {t('about.story.title')}
          </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-2xl sm:text-3xl text-navy font-semibold text-center mb-12">
            {t('about.values.title')}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {(['independence', 'confidentiality', 'depth'] as const).map((value) => (
              <div key={value} className="text-center p-8">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(['adrian', 'robin'] as const).map((founder) => (
              <div key={founder} className="bg-white rounded-xl p-8 shadow-sm border border-navy/5">
      ...
      <section className="py-20 bg-navy">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl sm:text-3xl text-white font-semibold mb-12">
            {t('about.offices.title')}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {(['zurich', 'zug', 'schwyz'] as const).map((office) => (
              <div key={office} className="border border-gold/20 rounded-xl p-8">
                ...
                <p className="text-xs text-white/40 mt-1">Switzerland</p>
              </div>
            ))}
          </div>
        </div>
