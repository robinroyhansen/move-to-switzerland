...
export const insights: Record<InsightSlug, InsightMeta> = {
  ...
  'lex-koller-swiss-real-estate': {
    ...
    date: '2026-04-01',
    readTime: 10,
    image: '/images/swiss-real-estate.jpg',
  ...
  'best-international-schools-zurich-zug-schwyz': {
    ...
    date: '2026-04-01',
    readTime: 11,
    image: '/images/swiss-schools.jpg',
  ...
  'relocating-to-switzerland-timeline': {
    ...
    date: '2026-04-01',
    readTime: 9,
    image: '/images/swiss-timeline.jpg',
  ...
  'opening-swiss-private-bank-account': {
    ...
    date: '2026-04-01',
    readTime: 10,
    image: '/images/swiss-banking.jpg',
  ...
  'swiss-residency-permits-guide': {
    ...
    date: '2026-04-01',
    readTime: 11,
    image: '/images/swiss-permits.jpg',
  ...
  'why-wealthy-families-leaving-uae-for-switzerland': {
    ...
    date: '2026-04-01',
    readTime: 9,
    image: '/images/uae-switzerland.jpg',
  ...
  'setting-up-family-office-switzerland': {
    ...
    date: '2026-04-01',
    readTime: 12,
    image: '/images/family-office-setup.jpg',
